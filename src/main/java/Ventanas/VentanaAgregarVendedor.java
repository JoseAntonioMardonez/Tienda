...
public class VentanaAgregarVendedor extends Ventana {
    ...
    public VentanaAgregarVendedor(Tienda tienda) {
    ...
    private void generarMensajeEncabezado() {
        String textoEncabezado = "Agregar Vendedor";
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.botonAgregar) {
            ...
            Vendedor vendedor = new Vendedor(nombreUsuario,contrasena);
